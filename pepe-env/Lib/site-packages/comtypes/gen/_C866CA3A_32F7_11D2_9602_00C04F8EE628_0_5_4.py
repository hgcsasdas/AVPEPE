...
__all__ = [
    'SpeechTokenKeyFiles', 'SAFT48kHz16BitMono',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SLWWord',
    'DISPID_SLGetPronunciations', 'SASRun', 'eLEXTYPE_USER',
    'SPPS_RESERVED3', 'DISPID_SRIsShared',
    'DISPID_SRCERecognitionForOtherContext', 'SPEI_END_SR_STREAM',
    'ISpeechPhraseReplacements', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SVEBookmark', 'SpeechInterference',
    'ISpeechPhraseProperty', 'SLODynamic', 'DISPID_SGRSTsItem',
    'SPSLMA', 'DISPID_SWFEBlockAlign', 'DISPID_SOTMatchesAttributes',
    'ISpeechRecognizerStatus', 'STCAll', 'SRSActive',
    'DISPID_SLWsCount', 'DISPID_SWFEAvgBytesPerSec',
    'ISpeechObjectToken', 'DISPID_SRCEStartStream',
    'ISpObjectTokenCategory', 'SP_VISEME_13', 'DISPID_SRCRecognizer',
    'DISPID_SPERetainedStreamOffset', 'SVP_15',
    'DISPID_SPERequiredConfidence', 'DISPID_SGRAttributes',
    'DISPID_SVPause', 'SPRECOSTATE', 'SWTAdded', 'DISPID_SGRsItem',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPPName', 'SDTAll', 'SpeechCategoryAudioOut',
    '__MIDL_IWinTypes_0009', 'SPVPRI_OVER', 'DISPID_SOTCId',
    'ISpeechAudioBufferInfo', 'DISPID_SVPriority',
    'DISPID_SPEPronunciation', 'SPCONTEXTSTATE',
    'SVSFParseAutodetect', 'DISPID_SRCEAudioLevel',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SRGetPropertyString',
    'DISPID_SPRText', 'DISPID_SRCCmdMaxAlternates',
    'SpeechSpecialTransitionType', 'SP_VISEME_14',
    'DISPID_SRGSetTextSelection', 'WAVEFORMATEX', 'SDTProperty',
    'SVSFVoiceMask', 'DISPID_SDKOpenKey', 'DISPID_SVSInputWordLength',
    'DISPID_SDKGetStringValue', 'DISPID_SPAsItem',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SVSInputWordPosition',
    'SVEWordBoundary', 'SpMemoryStream', 'DISPID_SOTCSetId',
    'ISpRecognizer2', 'DISPID_SVAudioOutputStream', 'ISpDataKey',
    'SPEI_SR_PRIVATE', 'SPSEMANTICFORMAT',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SRRPhraseInfo',
    'ISpeechRecognizer', 'DISPID_SPEsCount', 'SPWT_LEXICAL',
    'DISPID_SpeechMMSysAudio',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SECFEmulateResult', 'SVEStartInputStream', 'SP_VISEME_4',
    'SRAInterpreter', 'ISequentialStream', 'eLEXTYPE_PRIVATE11',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SDKSetStringValue', 'DISPID_SPIReplacements',
    'SpeechAllElements', 'DISPID_SPIProperties', 'SPAR_Low',
    'DISPID_SGRSTType', 'DISPID_SWFEChannels', 'SAFT12kHz8BitStereo',
    'SpeechPropertyLowConfidenceThreshold', 'SPWORDLIST',
    'SPSModifier', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SRCState', 'DISPID_SAVolume',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SRCEHypothesis', 'DISPID_SGRSTWeight', 'SGDisplay',
    'SECFIgnoreKanaType', 'Speech_Default_Weight',
    'DISPID_SOTCEnumerateTokens', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SpeechRecoResult', 'DISPID_SDKGetlongValue',
    'DISPID_SpeechRecoContext', 'SpeechRegistryLocalMachineRoot',
    'SRATopLevel', 'DISPID_SRCRetainedAudioFormat', 'SVP_3',
    'STCRemoteServer', 'SpeechCategoryAppLexicons',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SVSpeakStream',
    'ISpeechPhraseReplacement', 'DISPID_SPRules_NewEnum',
    'DISPID_SpeechGrammarRuleStateTransition', 'eLEXTYPE_PRIVATE19',
    'SRAONone', 'DISPID_SRGCommit', 'SPPS_SuppressWord',
    'DISPID_SPPFirstElement', 'SPPS_Interjection',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SLPType',
    'ISpeechPhraseRule', 'IInternetSecurityManager',
    'SAFT32kHz8BitStereo', 'SpMMAudioIn', 'SRTExtendableParse',
    'DISPID_SRRSaveToMemory', 'DISPID_SVStatus', 'eLEXTYPE_PRIVATE1',
    'SpeechAudioVolume', 'DISPID_SPISaveToMemory', 'SpeechVisemeType',
    'SREFalseRecognition', 'ISpeechLexicon',
    'DISPID_SPRuleEngineConfidence',
    'SpeechGrammarTagUnlimitedDictation', 'SLOStatic',
    'SSSPTRelativeToCurrentPosition', 'Speech_StreamPos_RealTime',
    'SGSEnabled', 'DISPID_SRGDictationUnload',
    'DISPIDSPTSI_ActiveOffset', 'SPRST_ACTIVE', 'DISPID_SRRAudio',
    'SAFTADPCM_8kHzStereo', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SPACommit', 'SPPARTOFSPEECH', 'DISPID_SPIStartTime',
    'SWPUnknownWordPronounceable', 'SAFT16kHz8BitStereo',
    'DISPID_SRIsUISupported', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SBSWrite', 'DISPID_SVSInputSentenceLength',
    'DISPID_SAFSetWaveFormatEx', 'SP_VISEME_8', 'SPAO_RETAIN_AUDIO',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SRRTOffsetFromStart',
    'SPPHRASERULE', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SRCEBookmark', 'DISPID_SASCurrentDevicePosition',
    'ISpeechVoiceStatus', 'SVSFNLPSpeakPunc', 'SVP_2',
    'SRSInactiveWithPurge', 'Speech_Max_Pron_Length',
    'DISPID_SBSFormat', 'SSFMCreateForWrite', 'DISPID_SMSALineId',
    'DISPID_SVVoice', 'DISPID_SABufferInfo', 'SPPS_Unknown',
    'ISpShortcut', 'eLEXTYPE_PRIVATE18',
    'DISPID_SRCERecognizerStateChange', 'SP_VISEME_21',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SPRFirstElement',
    'DISPID_SLWType', 'SPSERIALIZEDPHRASE',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SpeechObjectToken',
    'SpeechCategoryAudioIn', 'SPPHRASEREPLACEMENT',
    'eLEXTYPE_PRIVATE10', 'SAFTCCITT_uLaw_11kHzMono',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpSharedRecoContext',
    'SPRS_ACTIVE', 'SVP_7', 'SASPause', 'DISPID_SpeechLexiconProns',
    'SPAR_Medium', 'ISpeechPhraseProperties', 'SRSEDone',
    'SPPS_RESERVED1', 'SP_VISEME_0', 'SPAS_RUN',
    'SREPropertyStringChange', 'DISPID_SRAudioInputStream',
    'DISPID_SBSRead', 'SITooFast', 'SpeechStreamSeekPositionType',
    'SpShortcut', 'DISPID_SVIsUISupported', 'SP_VISEME_17',
    'DISPID_SAFGetWaveFormatEx', 'SAFT8kHz8BitStereo',
    'DISPID_SRRSpeakAudio', 'SVP_17', 'SRSEIsSpeaking',
    'SDTLexicalForm', 'DISPID_SRCVoicePurgeEvent',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SRCEAdaptation',
    'DISPID_SVSRunningState', 'DISPID_SPCPhoneToId',
    'DISPID_SRCRetainedAudio', 'SLTApp', 'SVSFIsFilename',
    'DISPID_SWFEBitsPerSample', 'DISPID_SVGetVoices',
    'SpNotifyTranslator', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SVGetAudioOutputs', 'SVSFDefault',
    'DISPID_SRCEFalseRecognition', 'SPEVENT', 'DISPID_SVEAudioLevel',
    'ISpeechGrammarRuleStateTransition', 'SPGS_DISABLED',
    'SRERecoOtherContext', 'SASStop', 'SpeechTokenIdUserLexicon',
    'DISPID_SOTCDefault', 'DISPID_SOTGetDescription', 'SRTReSent',
    'SGDSActiveUserDelimited', 'DISPID_SPIEngineId',
    'SPEI_END_INPUT_STREAM', 'DISPID_SWFEExtraData',
    'eLEXTYPE_PRIVATE17', 'DISPID_SOTCreateInstance',
    'SAFTADPCM_11kHzMono', 'DISPID_SRDisplayUI',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SRGCmdSetRuleState',
    'SpAudioFormat', 'SpStreamFormatConverter', 'DISPID_SPIGrammarId',
    'SVP_6', 'DISPID_SRSAudioStatus', 'SPRS_ACTIVE_USER_DELIMITED',
    'ISpEventSource', 'DISPID_SRGRules', 'SVEPrivate',
    'SECFIgnoreWidth', 'SSTTDictation', 'DISPID_SPEAudioSizeTime',
    'SPVPRI_ALERT', 'SRAORetainAudio', 'SGRSTTDictation',
    'SREStateChange', 'ISpeechMemoryStream',
    'DISPID_SPIRetainedSizeBytes', 'ISpPhrase', 'SWTDeleted',
    'DISPID_SABIEventBias', 'SPAUDIOOPTIONS',
    'DISPID_SpeechXMLRecoResult', 'SpeechDictationTopicSpelling',
    'DISPID_SPPsItem', 'SpMMAudioEnum', 'DISPID_SOTDataKey',
    'DISPID_SpeechPhraseAlternates', 'SPAS_STOP', 'SPWF_SRENGINE',
    'SPINTERFERENCE_NOSIGNAL', 'ISpLexicon', 'SAFT12kHz16BitMono',
    'ISpeechWaveFormatEx', 'eLEXTYPE_PRIVATE16', 'SPRECORESULTTIMES',
    'eLEXTYPE_PRIVATE12', 'DISPID_SRRDiscardResultInfo',
    'ISpeechPhraseInfoBuilder', 'SSTTTextBuffer',
    'DISPID_SPELexicalForm', 'DISPID_SpeechPhraseElements',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SRGCmdLoadFromObject',
    'SPEI_TTS_PRIVATE', 'SDTReplacement', 'SECNormalConfidence',
    'ISpResourceManager', 'DISPID_SGRSTRule', 'SVSFlagsAsync',
    'STSF_CommonAppData', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SpeechAudioFormat', '_SPAUDIOSTATE', 'SPGS_EXCLUSIVE',
    'SP_VISEME_5', 'SGDSInactive', 'SPCS_DISABLED',
    'DISPID_SRCRequestedUIType', 'DISPID_SVEVoiceChange',
    'DISPID_SRCEPropertyStringChange', 'SREPropertyNumChange',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SVEViseme',
    'SPSInterjection', 'ISpeechRecoResultDispatch', 'DISPID_SVRate',
    'SAFTDefault', 'SP_VISEME_18', 'DISPID_SOTId',
    'ISpeechFileStream', 'SFTSREngine', 'DISPID_SVGetAudioInputs',
    'ISpRecognizer3', 'SPWORDPRONUNCIATIONLIST', 'SP_VISEME_7',
    'SGDSActiveWithAutoPause', 'SpeechRuleState', 'SVEBookmark',
    'DISPID_SGRInitialState', 'ISpeechObjectTokens',
    'SAFTGSM610_11kHzMono', 'SpeechTokenKeyUI',
    'DISPID_SGRSAddWordTransition', 'DISPID_SLPsItem',
    'DISPID_SPIRule', 'SVP_0', 'SVPOver',
    'SpeechCategoryPhoneConverters', 'SDA_No_Trailing_Space',
    'SVSFPurgeBeforeSpeak', 'DISPID_SDKEnumValues', 'SREAdaptation',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SGRSTsCount',
    'DISPIDSPTSI_SelectionOffset', 'SPWORDPRONUNCIATION',
    'ISpeechPhraseRules', 'SPSHORTCUTPAIR', 'DISPID_SVSkip',
    'SpeechRegistryUserRoot', 'DISPID_SPERetainedSizeBytes',
    'SAFT11kHz16BitStereo', 'SRESoundStart', 'Speech_Max_Word_Length',
    'SPTEXTSELECTIONINFO', 'DISPID_SRCEventInterests',
    'SpeechAudioFormatGUIDWave', 'SSFMOpenReadWrite',
    'DISPID_SRGIsPronounceable', 'SPCT_COMMAND', 'eLEXTYPE_APP',
    'SPADAPTATIONRELEVANCE', 'SpeechLoadOption', 'SSFMCreate',
    'SPEI_MAX_TTS', 'SPEI_TTS_BOOKMARK',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SLWs_NewEnum',
    'SITooLoud', 'DISPID_SPIAudioSizeTime', 'DISPID_SVSPhonemeId',
    'SpeechCategoryRecoProfiles', 'DISPID_SpeechVoice',
    'SPEI_WORD_BOUNDARY', 'DISPID_SRRTTickCount',
    'SPSERIALIZEDRESULT', 'SRADynamic', 'DISPID_SRCERequestUI',
    'SPCT_SUB_DICTATION', 'SREAudioLevel', 'SPAR_Unknown',
    'ISpStreamFormatConverter', 'DISPID_SpeechPhraseProperties',
    'eLEXTYPE_PRIVATE3', 'DISPID_SRGCmdLoadFromResource', 'SVP_5',
    'SVEPhoneme', 'SpeechVoiceSpeakFlags', 'SVSFPersistXML',
    'DISPID_SASState', 'ISpNotifySink', 'DISPID_SPRs_NewEnum',
    'DISPID_SRGState', 'DISPID_SPPsCount',
    'DISPID_SRCreateRecoContext', 'ISpeechObjectTokenCategory',
    'DISPIDSPTSI', 'eLEXTYPE_RESERVED8', 'DISPID_SPRuleName',
    'eLEXTYPE_PRIVATE8', 'SPSHT_NotOverriden', 'DISPID_SVVolume',
    'SP_VISEME_11', 'SPEI_RESERVED2', 'SDKLCurrentConfig',
    'SAFT22kHz16BitMono', 'SPEI_TTS_AUDIO_LEVEL',
    'SpeechAudioFormatGUIDText', 'DISPID_SRRTimes',
    'ISpeechGrammarRuleState', 'DISPID_SpeechObjectTokenCategory',
    'SSTTWildcard', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SABufferNotifySize', 'DISPID_SGRAddState',
    'SREStreamStart', 'eLEXTYPE_PRIVATE15',
    'DISPID_SPPEngineConfidence', 'DISPID_SRSClsidEngine',
    'SPGRAMMARSTATE', 'ISpNotifyTranslator',
    'DISPID_SRCEPropertyNumberChange', 'SPWT_DISPLAY',
    'SAFT32kHz8BitMono', 'DISPID_SLWLangId', 'DISPID_SVSLastBookmark',
    'DISPID_SpeechRecoResult2', 'DISPID_SMSAMMHandle', 'SPAR_High',
    'ISpVoice', 'SDA_One_Trailing_Space', 'SVEVoiceChange',
    'SPSFunction', 'SVF_Stressed',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'ISpeechDataKey',
    'ISpeechGrammarRules', 'DISPID_SVAudioOutput', 'SREInterference',
    'DISPID_SRStatus', 'SpeechPartOfSpeech', 'SPRULE',
    'ISpMMSysAudio', 'SpPhoneConverter', 'ISpeechPhoneConverter',
    'DISPID_SABIBufferSize', 'IEnumString', 'DISPID_SOTDisplayUI',
    'SPEI_RECO_OTHER_CONTEXT', 'STCInprocServer', 'SP_VISEME_10',
    'SVP_12', 'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SVP_14',
    'SpTextSelectionInformation', '_ISpeechVoiceEvents',
    'DISPID_SRGId', 'SAFTNoAssignedFormat', 'eLEXTYPE_PRIVATE7',
    'DISPID_SPRuleChildren', 'DISPID_SGRSTPropertyValue',
    'SPSHORTCUTTYPE', 'DISPID_SWFEFormatTag', 'SpObjectToken',
    'DISPID_SGRName', 'SP_VISEME_2', 'eLEXTYPE_RESERVED7',
    'SGRSTTRule', 'ISpStream', 'IStream', 'SPSTREAMFORMATTYPE',
    'DISPID_SPEDisplayText', 'DISPID_SOTGetStorageFileName',
    'SPRECOGNIZERSTATUS', 'ISpRecoCategory',
    'DISPID_SDKSetBinaryValue', 'DISPID_SAEventHandle',
    'DISPID_SADefaultFormat', 'SAFT24kHz8BitStereo',
    'SPSEMANTICERRORINFO', 'SVESentenceBoundary',
    'SPEI_PROPERTY_NUM_CHANGE', 'SVEAllEvents', 'SAFT11kHz16BitMono',
    'SpeechWordPronounceable', 'SP_VISEME_6', 'DISPID_SOTsItem',
    'SPEI_RECOGNITION', 'ISpNotifySource',
    'DISPID_SpeechPhoneConverter', 'SpeechStreamFileMode',
    'SGSExclusive', 'SPEI_SOUND_START', 'DISPID_SRCVoice',
    'SPSMF_UPS', 'SVP_18', 'SpeechDisplayAttributes', 'SVF_None',
    'DISPID_SRCEPhraseStart', 'SRERecognition', 'DISPID_SLPsCount',
    'DISPID_SOTs_NewEnum', 'SpeechPropertyResponseSpeed', 'SINoise',
    'SpeechVisemeFeature', 'SAFT44kHz16BitMono',
    'DISPID_SPRuleFirstElement', 'SDKLLocalMachine',
    'SpeechRecoProfileProperties', 'DISPID_SLPs_NewEnum',
    'SDTDisplayText', 'ISpeechPhraseElements',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SDKDeleteValue',
    'ISpeechAudio', 'SpeechRecoEvents',
    'DISPID_SpeechRecognizerStatus', 'SPBOOKMARKOPTIONS',
    'IInternetSecurityMgrSite', 'DISPID_SDKDeleteKey',
    'SAFT24kHz16BitMono', 'DISPID_SPRuleConfidence', 'SP_VISEME_9',
    'SLTUser', 'SpFileStream', 'SVEAudioLevel', 'SASClosed',
    'SpPhoneticAlphabetConverter', 'SGLexicalNoSpecialChars',
    'SPPHRASEELEMENT', 'DISPID_SRCEInterference',
    'SpeechAddRemoveWord', 'DISPID_SVWaitUntilDone',
    'DISPID_SLAddPronunciation', 'eLEXTYPE_RESERVED9',
    'ISpeechResourceLoader', 'DISPID_SRCSetAdaptationData', 'SPWORD',
    'DISPID_SPPConfidence', 'SGRSTTTextBuffer', 'SITooQuiet',
    'SPFILEMODE', 'DISPID_SLPPhoneIds',
    'DISPID_SRGSetWordSequenceData', 'ISpPhoneticAlphabetSelection',
    'SVP_11', 'DISPID_SpeechLexiconWords',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SVGetProfiles',
    'SAFT24kHz16BitStereo', 'SP_VISEME_16',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SPPChildren',
    'SSSPTRelativeToEnd', 'SPEI_SOUND_END', 'ISpPhraseAlt',
    'SECFIgnoreCase', 'SPPS_Noncontent', 'DISPID_SLPPartOfSpeech',
    'SITooSlow', 'ISpGrammarBuilder', 'DISPID_SRCERecognition',
    'DISPID_SPIAudioSizeBytes', 'SRARoot', 'SGDSActive',
    'DISPID_SRGRecoContext', 'eLEXTYPE_PRIVATE20',
    'DISPID_SpeechWaveFormatEx', 'ISpeechBaseStream', 'UINT_PTR',
    'DISPID_SpeechPhraseRules', 'DISPID_SVEEnginePrivate',
    'SREStreamEnd', 'SpeechAudioFormatType', 'SPSHT_Unknown',
    'DISPID_SVEPhoneme', 'SPLEXICONTYPE', 'SPINTERFERENCE_NOISE',
    'SAFT32kHz16BitMono', 'SPEI_RESERVED3', 'SVEEndInputStream',
    'DISPID_SASNonBlockingIO', 'DISPID_SGRSRule', 'SpVoice',
    'SPGS_ENABLED', 'SRAExport', 'DISPID_SAFType',
    'SpInprocRecognizer', 'DISPID_SVSVisemeId', 'DISPID_SRCBookmark',
    'DISPID_SRSNumberOfActiveRules', 'SVSFParseSapi',
    'SPPHRASEPROPERTY', 'SPSSuppressWord', 'SPCT_SUB_COMMAND',
    'DISPID_SRGCmdLoadFromMemory', 'SPRST_INACTIVE',
    'SPFM_OPEN_READONLY', 'DISPID_SPEDisplayAttributes',
    'SpResourceManager', 'SINoSignal', 'SPDKL_LocalMachine',
    'DISPID_SpeechGrammarRules', 'ISpeechRecoResultTimes',
    'DISPID_SWFESamplesPerSec', 'DISPID_SPAsCount',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SpeechVoiceSkipTypeSentence', 'SpeechLexiconType',
    'SAFTNonStandardFormat', 'SPVPRI_NORMAL', 'tagSTATSTG',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SVEStreamStart',
    'SAFT32kHz16BitStereo', 'SAFT44kHz16BitStereo',
    'SSSPTRelativeToStart', 'DISPID_SPEsItem', 'SAFTADPCM_8kHzMono',
    'DISPID_SABIMinNotification', 'ISpPhoneticAlphabetConverter',
    'IEnumSpObjectTokens', 'SPBO_TIME_UNITS', 'ISpProperties',
    'SPLOADOPTIONS', 'ISpeechPhraseElement', 'DISPID_SBSSeek',
    'SAFTADPCM_22kHzMono', 'DISPID_SGRSTransitions',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPFM_CREATE',
    'DISPID_SLWPronunciations', 'DISPID_SPEs_NewEnum', 'SPSUnknown',
    'DISPID_SPPNumberOfElements', 'DISPID_SPEActualConfidence',
    'SGSDisabled', 'DISPID_SRGDictationSetState', 'STCInprocHandler',
    'DISPID_SGRId', 'SDKLCurrentUser', 'SRCS_Disabled',
    'SPEI_MIN_TTS', 'DISPID_SLAddPronunciationByPhoneIds',
    'SPBO_NONE', 'DISPID_SRRRecoContext', 'DISPID_SVEWord',
    'SpNullPhoneConverter', 'eLEXTYPE_PRIVATE2', 'SPVOICESTATUS',
    'DISPID_SVSyncronousSpeakTimeout', 'SPEVENTENUM', 'SPRS_INACTIVE',
    'SRSActiveAlways', 'SAFTADPCM_44kHzStereo',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SMSSetData', 'DISPID_SCSBaseStream', 'SPGRAMMARWORDTYPE',
    'SPEI_START_INPUT_STREAM', 'SPEI_RECO_STATE_CHANGE',
    'ISpRecoResult', 'ISpRecoContext',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SASCurrentSeekPosition',
    'SPEVENTSOURCEINFO', 'SPEI_ADAPTATION', 'SAFT11kHz8BitMono',
    'DISPID_SPPValue', 'SECLowConfidence',
    'DISPID_SRSetPropertyNumber', 'ISpeechMMSysAudio', 'SRCS_Enabled',
    'ISpeechPhraseAlternate', 'DISPID_SOTRemove',
    'ISpeechRecoContext', 'DISPID_SASetState', 'SAFT22kHz8BitMono',
    'DISPID_SGRSTPropertyName', 'SVSFParseSsml',
    'DISPID_SpeechVoiceEvent', 'SVP_1',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SREBookmark', 'SPPS_Noun',
    '_RemotableHandle', 'SDA_Two_Trailing_Spaces', 'DISPID_SRCPause',
    'eLEXTYPE_PRIVATE4', 'SP_VISEME_19', 'DISPID_SpeechCustomStream',
    'SPEI_PHRASE_START', 'SGLexical', 'SPAUDIOSTATE',
    'SPXRO_Alternates_SML', 'SPEI_SR_AUDIO_LEVEL', 'SpStream',
    'DISPID_SPIGetText', 'SP_VISEME_20', 'DISPID_SpeechLexicon',
    'eLEXTYPE_LETTERTOSOUND', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SVEventInterests', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SPRuleNumberOfElements', 'eWORDTYPE_DELETED',
    'DISPID_SPRDisplayAttributes', 'DISPID_SRRTLength',
    'SDKLDefaultLocation', 'SpeechVoiceEvents',
    'SPEI_FALSE_RECOGNITION', 'SPSNotOverriden',
    'SpCompressedLexicon', 'DISPID_SGRsFindRule', 'SRERequestUI',
    'SBONone', 'SVPAlert', 'SVP_8', 'eLEXTYPE_PRIVATE5',
    'SpeechPropertyResourceUsage', 'SPEI_REQUEST_UI',
    'STSF_LocalAppData', 'eLEXTYPE_PRIVATE14',
    'SpeechEngineProperties', 'SRADefaultToActive',
    'DISPID_SpeechBaseStream', 'SAFTExtendedAudioFormat',
    'SAFT12kHz16BitStereo', 'DISPID_SDKSetLongValue',
    'ISpSerializeState', 'ISpObjectToken', 'DISPID_SGRsCommitAndSave',
    'SpeechCategoryRecognizers', 'DISPID_SPRsItem',
    'ISpeechRecoResult2', 'DISPID_SRSSupportedLanguages',
    'ISpStreamFormat', 'SPSVerb', 'DISPID_SpeechAudio', 'SVP_10',
    'DISPID_SVSLastBookmarkId', 'DISPID_SVResume',
    'SPRST_ACTIVE_ALWAYS', 'SpeechRecoContextState',
    'DISPID_SPEEngineConfidence', 'SPEI_UNDEFINED', 'SVP_19',
    'ISpeechAudioStatus', 'SPEI_MIN_SR', 'ISpeechVoice',
    'SAFT48kHz8BitStereo', 'DISPID_SpeechPhraseElement',
    'DISPID_SRSetPropertyString', 'ISpRecoGrammar2', 'SPSNoun',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SRState',
    'SPEI_HYPOTHESIS', 'DISPID_SpeechPhraseBuilder',
    'SPFM_CREATE_ALWAYS', 'ISpPhoneConverter',
    'SAFTCCITT_ALaw_8kHzMono', 'ISpeechAudioFormat', 'SINone',
    'SPWORDPRONOUNCEABLE', 'DISPID_SRGetRecognizers',
    'SAFT16kHz8BitMono', 'SPPS_Verb', 'DISPID_SRCResume',
    'SAFTGSM610_22kHzMono', 'DISPID_SGRs_NewEnum',
    'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SRCESoundStart',
    'DISPID_SFSOpen', 'SREHypothesis', 'SAFTText', 'SPAO_NONE',
    'SRAImport', 'SPCT_DICTATION', 'DISPID_SpeechMemoryStream',
    'DISPID_SRRSetTextFeedback',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SRGReset',
    'SPSHT_EMAIL', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SRCEEndStream', 'DISPID_SPPs_NewEnum',
    'SpeechTokenShellFolder', 'SPEI_INTERFERENCE', 'SPWORDTYPE',
    'SECFNoSpecialChars', 'SPLO_STATIC', 'SAFTGSM610_8kHzMono',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SVESentenceBoundary',
    'SpeechBookmarkOptions', 'DISPID_SpeechPhraseInfo',
    'eLEXTYPE_RESERVED4', 'SpUnCompressedLexicon',
    'SPDATAKEYLOCATION', 'DISPID_SpeechGrammarRule',
    'DISPID_SRAudioInput', 'SAFTGSM610_44kHzMono',
    'ISpeechTextSelectionInformation', 'SPPS_Modifier',
    'SVSFParseMask', 'DISPID_SRCCreateGrammar', 'SpeechFormatType',
    'ISpeechRecoGrammar', 'SpLexicon', 'SpInProcRecoContext',
    'DISPID_SpeechVoiceStatus', 'SBOPause', 'SPXMLRESULTOPTIONS',
    'DISPID_SRRGetXMLResult', 'SpeechTokenValueCLSID',
    'SpeechDataKeyLocation', 'SpeechRuleAttributes',
    'DISPID_SGRSTText', 'SpCustomStream', 'SAFT8kHz16BitStereo',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'ISpRecognizer',
    'eLEXTYPE_MORPHOLOGY', 'SPBINARYGRAMMAR', 'SAFT44kHz8BitStereo',
    'SpeechDiscardType', 'SpeechAudioProperties', 'STCLocalServer',
    'DISPID_SpeechObjectTokens', 'SDTAudio', 'SPPHRASE',
    'DISPID_SMSADeviceId', 'DISPID_SMSGetData',
    'DISPID_SpeechRecognizer', 'SPEI_RESERVED6', 'DISPID_SOTsCount',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SpeechRecognizerState',
    'DISPID_SVSpeak', 'SPFM_NUM_MODES', 'SPRULESTATE',
    'eLEXTYPE_PRIVATE6', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SPRuleId', 'SPPROPERTYINFO', 'DISPID_SGRSTs_NewEnum',
    'SAFT16kHz16BitStereo', 'SpeechUserTraining', 'SVSFIsXML',
    'SPXRO_SML', 'SPSMF_SAPI_PROPERTIES', 'SVP_13',
    'DISPID_SDKEnumKeys', 'SPEI_RESERVED5', 'DISPID_SGRClear',
    'LONG_PTR', 'DISPID_SpeechLexiconWord', 'SpeechGrammarWordType',
    'SPDKL_DefaultLocation', 'SVPNormal', 'SPBO_PAUSE', 'SPVISEMES',
    'eLEXTYPE_USER_SHORTCUT', 'SPWT_PRONUNCIATION',
    'ISpeechLexiconPronunciations', 'SVP_16', 'SPEI_SR_BOOKMARK',
    'SP_VISEME_1', 'SpeechWordType', 'SAFT8kHz8BitMono',
    'DISPID_SLPSymbolic', 'eWORDTYPE_ADDED', 'DISPID_SVSLastResult',
    'SVP_21', 'SDTRule', 'SPPS_LMA', 'DISPID_SPRNumberOfElements',
    'SECHighConfidence', 'SVP_9', 'DISPID_SRGetPropertyNumber',
    'ISpXMLRecoResult', 'SGPronounciation', 'SPSHORTCUTPAIRLIST',
    'SECFDefault', 'SVSFUnusedFlags', 'DISPID_SpeechPhraseRule',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SVSFIsNotXML',
    'DISPID_SPARecoResult', 'DISPID_SOTIsUISupported',
    'SGRSTTWildcard', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SPEAudioSizeBytes', 'SAFT24kHz8BitMono', 'SVP_20',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPPS_RESERVED4', 'SVP_4',
    'SSFMOpenForRead', 'DISPID_SPPId', 'SpeechPropertyAdaptationOn',
    'ISpeechLexiconWord', 'DISPID_SGRSTNextState',
    'SpeechRecognitionType', 'SpeechMicTraining',
    'SAFTADPCM_44kHzMono', 'SWPUnknownWordUnpronounceable',
    'SpeechTokenContext', 'SPWAVEFORMATTYPE', 'DISPID_SGRAddResource',
    'ISpEventSink', 'SpeechCategoryVoices', 'SpPhraseInfoBuilder',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SGRSTPropertyId',
    'SpeechVoicePriority', 'SVF_Emphasis', 'DISPID_SLGetWords',
    'SPVPRIORITY', 'DISPID_SGRsAdd', 'ISpeechPhraseInfo',
    'tagSPPROPERTYINFO', 'DISPID_SLPLangId', 'ISpObjectWithToken',
    'DISPIDSPRG', 'DISPID_SRProfile', 'SPCT_SLEEP', 'ISpRecoContext2',
    'SAFT22kHz8BitStereo', 'SRTEmulated', 'SRTAutopause',
    'SAFTCCITT_uLaw_8kHzMono', 'SAFTCCITT_ALaw_11kHzStereo',
    'Speech_StreamPos_Asap', 'DISPID_SLGetGenerationChange',
    'eLEXTYPE_RESERVED6', 'SP_VISEME_12',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPAUDIOSTATUS',
    'SPSHT_OTHER', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SRSCurrentStreamPosition', 'SRTStandard',
    'DISPID_SASFreeBufferSpace', 'DISPID_SPEAudioStreamOffset',
    'SPPS_RESERVED2', 'SPEI_MAX_SR', 'SAFT48kHz8BitMono',
    'SpWaveFormatEx', 'SP_VISEME_3', '_ISpeechRecoContextEvents',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SAStatus',
    'SpeechRetainedAudioOptions', 'SPEI_VISEME',
    'DISPID_SpeechAudioStatus', 'SpeechTokenKeyAttributes',
    'ISpeechGrammarRule', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SGRsDynamic', 'SDA_Consume_Leading_Spaces',
    'DISPID_SVEStreamEnd', 'SDTPronunciation', 'DISPID_SpeechDataKey',
    'DISPID_SPAStartElementInResult', 'SPEI_VOICE_CHANGE',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SPRulesCount',
    'SFTInput', 'DISPID_SGRsCommit', 'SREAllEvents',
    'ISpeechCustomStream', 'STSF_FlagCreate',
    'SAFTCCITT_uLaw_44kHzStereo', 'SREPhraseStart', 'SPEI_RESERVED1',
    'SpeechGrammarTagWildcard', 'SpMMAudioOut', 'SPPS_NotOverriden',
    'SDTAlternates', 'SAFT8kHz16BitMono', 'DISPID_SPAPhraseInfo',
    'DISPID_SPRsCount', 'SRSInactive', 'SGRSTTWord',
    'DISPID_SPAs_NewEnum', 'DISPID_SVDisplayUI',
    'DISPID_SDKGetBinaryValue', 'DISPID_SREmulateRecognition',
    'SPFM_OPEN_READWRITE', 'SpObjectTokenCategory', 'SPCATEGORYTYPE',
    'SAFT44kHz8BitMono', 'SPAUDIOBUFFERINFO', 'DISPID_SPRulesItem',
    'DISPID_SLGenerationId', 'eLEXTYPE_PRIVATE13', 'ISpRecoGrammar',
    'DISPID_SRRecognizer', 'SPRECOCONTEXTSTATUS',
    'DISPID_SRGetFormat', 'SPCS_ENABLED', 'DISPID_SPRuleParent',
    'SAFTADPCM_22kHzStereo', 'DISPID_SRCESoundEnd',
    'SAFT12kHz8BitMono', 'SAFT16kHz16BitMono', 'DISPID_SPILanguageId',
    'DISPID_SRGCmdSetRuleIdState', 'SREPrivate', 'SVEViseme',
    'SWPKnownWordPronounceable', 'DISPID_SVAlertBoundary',
    'DISPID_SRCEEnginePrivate', 'DISPID_SPPParent',
    'DISPID_SpeechFileStream', 'SPINTERFERENCE_TOOFAST',
    'eLEXTYPE_RESERVED10', 'ISpeechPhraseAlternates', 'SPLO_DYNAMIC',
    'SpeechAudioState', 'SPWF_INPUT', 'SRTSMLTimeout',
    'DISPID_SPIEnginePrivateData', 'SAFT11kHz8BitStereo',
    'ISpeechXMLRecoResult', 'DISPID_SPIElements',
    'DISPID_SOTCategory', 'STSF_AppData',
    'DISPID_SpeechPhraseAlternate', 'SPRST_NUM_STATES',
    'SPEI_START_SR_STREAM', 'DISPID_SpeechPhraseProperty',
    'SpSharedRecognizer', 'SAFTCCITT_ALaw_44kHzMono',
    'SpeechPropertyHighConfidenceThreshold', 'eLEXTYPE_PRIVATE9',
    'SPINTERFERENCE', 'SPPS_Function', 'DISPID_SpeechRecoResultTimes',
    'SAFTADPCM_11kHzStereo', 'ISpeechLexiconPronunciation',
    'SPEI_PHONEME', 'SpeechEmulationCompareFlags',
    'ISpeechRecoResult', 'SRESoundEnd', 'SPAS_PAUSE',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SP_VISEME_15',
    'SAFT22kHz16BitStereo', 'SGRSTTEpsilon', 'ISpAudio',
    'DISPID_SOTSetId', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SOTGetAttribute',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SLRemovePronunciation', 'DISPID_SLWsItem',
    'ISpeechLexiconWords', 'SPBO_AHEAD', 'DISPID_SRRAlternates',
    'DISPID_SAFGuid', 'SVSFNLPMask', 'SPDKL_CurrentConfig',
    'DISPID_SRCAudioInInterferenceStatus', 'SPINTERFERENCE_NONE',
    'DISPID_SRRTStreamTime', 'DISPID_SGRsCount',
    'SpeechGrammarTagDictation', 'DISPID_SOTCGetDataKey',
    'DISPID_SRRAudioFormat', 'DISPID_SPCLangId', 'SpeechGrammarState',
    'SpeechEngineConfidence', 'DISPID_SFSClose', 'SPDKL_CurrentUser',
    'DISPID_SVSInputSentencePosition', 'SpeechRunState',
    'DISPIDSPTSI_SelectionLength', 'SPAS_CLOSED',
    'DISPID_SDKCreateKey', 'DISPID_SPCIdToPhone',
    'DISPID_SRGDictationLoad', 'SAFT48kHz16BitStereo'
]

_check_version('1.1.14', 1662606487.041287)
